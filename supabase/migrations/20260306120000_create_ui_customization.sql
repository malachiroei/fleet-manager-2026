...
-- פרו: טבלה קיימת לעיתים בלי עמודות key/default_label — CREATE IF NOT EXISTS מדלג,
-- ולכן חובה ADD COLUMN לפני INSERT.
-- ─────────────────────────────────────────────────────────────────────────────
...
-- Seed default navigation labels (Hebrew); idempotent, בלי ON CONFLICT (אין תמיד UNIQUE על key)
