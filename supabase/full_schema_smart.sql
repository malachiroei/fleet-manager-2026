...
-- CREATE OR REPLACE FUNCTION to check if user has any management role
...
-- CREATE OR REPLACE FUNCTION to check if user is driver for specific driver record
...
-- CREATE OR REPLACE FUNCTION to update vehicle odometer from maintenance log
...
-- CREATE OR REPLACE FUNCTION to update compliance status
...
CREATE INDEX IF NOT EXISTS idx_smart_anon_1_public_vehicle_expenses ON public.vehicle_expenses (vehicle_id, expense_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_smart_anon_2_public_vehicle_incidents ON public.vehicle_incidents (vehicle_id, incident_date DESC);
CREATE INDEX IF NOT EXISTS idx_smart_anon_3_public_vehicle_incidents ON public.vehicle_incidents (vehicle_id, incident_type);
