-- =============================================================================
-- תיקון פרו: column "odometer" of relation "mileage_logs" does not exist
-- הטבלה מגדירה odometer_value; גרסה ישנה/ידנית של submit_mileage_report השתמשה ב-odometer.
-- מחליף מחדש את גוף הפונקציה (זהה ל-20260406140000) + reload ל-PostgREST.
-- =============================================================================
