  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-10 w-full rounded-md border border-input bg-white px-3 py-2 text-base text-slate-900 ring-offset-background",
          ...
          "dark:bg-slate-950/60 dark:text-foreground",
          className,
        )}
        ref={ref}
        {...props}
